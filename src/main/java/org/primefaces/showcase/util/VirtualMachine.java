...
public final class VirtualMachine {
   ...
   public static String getMemoryStatisticsAsString() {
      ...
      result.append("Memory Used: ");
      result.append(byteCountToDisplaySize(usedMemory));
      result.append(" Free: ");
      result.append(byteCountToDisplaySize(availableMemory));
      result.append(" Max: ");
      result.append(byteCountToDisplaySize(maxMemory));
